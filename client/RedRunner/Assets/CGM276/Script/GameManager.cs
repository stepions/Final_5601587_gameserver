...
namespace RedRunner
{
	...
	public sealed class GameManager : MonoBehaviour
	{
		...
		void MainCharacter_OnDead ()
		{
			...
			{
				m_HighScore = m_Score;
				GlobalData.score = Mathf.FloorToInt(m_HighScore);
				GlobalData.UpdateScore();
			}
		...
		void OnApplicationQuit ()
		{
			...
			SaveGame.Save<int> ( "coin", 0 );
			SaveGame.Save<float> ( "lastScore", 0f );
			SaveGame.Save<float> ( "highScore", 0f );
		}
